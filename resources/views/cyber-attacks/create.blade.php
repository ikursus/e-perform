...
@section('title', 'Tambah Cyber Attack')
@section('subtitle', 'Masukkan data serangan siber baru')
...
<div class="form-container">
    <div class="form-header">
        <h2><i class="fas fa-shield-alt"></i> Tambah Data Serangan Siber</h2>
        <p>Sila isi semua maklumat yang diperlukan dengan lengkap</p>
    </div>
    ...
    <div class="security-notice">
        ...
        <div class="security-notice-content">
            ...
            <p>Data serangan siber adalah maklumat sensitif. Pastikan semua data yang dimasukkan adalah tepat dan sahih untuk tujuan analisis keselamatan.</p>
        </div>
    </div>
    
    <form action="{{ route('cyber-attacks.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <select id="measurement" 
                ...
                <option value="Per Hari" {{ old('measurement') == 'Per Hari' ? 'selected' : '' }}>Per Hari</option>
                <option value="Per Minggu" {{ old('measurement') == 'Per Minggu' ? 'selected' : '' }}>Per Minggu</option>
                <option value="Per Bulan" {{ old('measurement') == 'Per Bulan' ? 'selected' : '' }}>Per Bulan</option>
                <option value="Per Tahun" {{ old('measurement') == 'Per Tahun' ? 'selected' : '' }}>Per Tahun</option>
                <option value="Per Jam" {{ old('measurement') == 'Per Jam' ? 'selected' : '' }}>Per Jam</option>
                <option value="Per Minit" {{ old('measurement') == 'Per Minit' ? 'selected' : '' }}>Per Minit</option>
                <option value="Sekali" {{ old('measurement') == 'Sekali' ? 'selected' : '' }}>Sekali Sahaja</option>
                <option value="Berterusan" {{ old('measurement') == 'Berterusan' ? 'selected' : '' }}>Berterusan</option>
            </select>
