...
@section('title', 'Tambah Investor Holding')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title mb-0">Tambah Investor Holding Baru</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('investor-holdings.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('fund_code') is-invalid @enderror" 
                                           id="fund_code" name="fund_code" value="{{ old('fund_code') }}" 
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('fund_name') is-invalid @enderror" 
                                           id="fund_name" name="fund_name" value="{{ old('fund_name') }}" 
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           id="total_investment" name="total_investment" value="{{ old('total_investment') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" 
                                           ...
                                           id="unrealized_pl_myr" name="unrealized_pl_myr" value="{{ old('unrealized_pl_myr') }}" 
                                           placeholder="0.00">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" 
                                           ...
                                           id="unrealized_pl_percentage" name="unrealized_pl_percentage" value="{{ old('unrealized_pl_percentage') }}" 
                                           placeholder="0.00">
