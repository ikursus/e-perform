...
@section('title', 'Tambah Internet Connection')
@section('subtitle', 'Masukkan data sambungan internet baru')
...
<div class="form-container">
    <div class="form-header">
        <h2><i class="fas fa-wifi"></i> Tambah Data Internet Connection</h2>
        <p>Sila isi semua maklumat yang diperlukan dengan lengkap</p>
    </div>
    
    <form action="{{ route('internet-connections.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <select id="measurement" 
                ...
                <option value="Mbps" {{ old('measurement') == 'Mbps' ? 'selected' : '' }}>Mbps (Megabits per second)</option>
                <option value="Gbps" {{ old('measurement') == 'Gbps' ? 'selected' : '' }}>Gbps (Gigabits per second)</option>
                <option value="Kbps" {{ old('measurement') == 'Kbps' ? 'selected' : '' }}>Kbps (Kilobits per second)</option>
            </select>
